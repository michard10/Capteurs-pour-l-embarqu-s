...
// sixtron::scd4x_measurement_t test_periodic_measurement(sixtron::SCD4X &sensor)
// {
//     sixtron::scd4x_measurement_t measure;
//     sixtron::SCD4X::ErrorType err;
...
//             continue;
//         }
//         err = sensor.read_measurement(&measure);
//         display_value_result(err, measure.co2, measure.temperature, measure.rh);
...
// static sixtron::scd4x_measurement_t test_single_shot_measurement(sixtron::SCD4X &sensor)
// {
...
//     packet_len = sprintf((char *) tx_buffer, "{\"Temperature\": %f, \"Humidity\": %f, \"CO2\": %d}",
//                          meas.temperature,  meas.rh, meas.co2);
...
int main(void)
{
    ...
    Capteur capteur(P1_I2C_SDA, P1_I2C_SCL);
    capteur.init();
    capteur.startPeriodicMeasurement();
    capteur.readMeasurement();
